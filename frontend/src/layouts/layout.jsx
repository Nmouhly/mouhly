...
export default function Layout() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <footer className="bg-white-400 text-white py-6">
  <div className="container mx-auto px-4">
    <div className="flex flex-wrap justify-between items-start">
      <div className="w-full md:w-5/12 mb-4 md:mb-0">
        <img src={logo} alt="Logo FSTG" className="h-16 w-auto mb-4"/> {/* Adjusted height */}
        <p className="text-sm">
      ...
      <div className="w-full md:w-1/12 mb-4 md:mb-0">
        {/* Empty column or add content here if needed */}
      </div>
      <div className="w-full md:w-5/12 mb-4 md:mb-0">
        <h2 className="text-lg font-bold mb-4">CONTACTEZ NOUS</h2>
        <ul className="text-sm">
          <li>Faculté des Sciences et Techniques B.P 549, Av.Abdelkarim Elkhattabi, Guéliz Marrakech</li>
